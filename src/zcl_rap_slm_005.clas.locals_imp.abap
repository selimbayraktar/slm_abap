...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zrap_slm_u_s01( <entity> MAPPING FROM ENTITY ).
...
CLASS lhc_Travel_2 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lhc_Travel_2 IMPLEMENTATION.
