   ...
   CLASS ltcl_integration_test DEFINITION FINAL FOR TESTING
    ...
    CLASS ltcl_integration_test IMPLEMENTATION.
     ...
     METHOD create_travel.
      ...
      DATA travels_in TYPE TABLE FOR CREATE ZI_RAP_SLM_U_CDS01\\travel.
      ...
      MODIFY ENTITIES OF ZI_RAP_SLM_U_CDS01
        ENTITY travel
      ...
      SELECT * FROM ZI_RAP_SLM_U_CDS01 WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
